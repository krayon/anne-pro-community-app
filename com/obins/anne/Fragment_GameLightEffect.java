...
public class Fragment_GameLightEffect extends Fragment {
    private MyAdapter adapter = null;
    private ListView gameLightEffect_listView;
    ...
    public class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (Fragment_GameLightEffect.this.selectItem == position) {
            ...
            convertView.setOnClickListener(new OnClickListener() {
                public void onClick(View arg0) {
                    if (!((ItemObject) MyAdapter.this.data.get(position)).lighteffectString.equals("自定义")) {
                        ...
                        if (Fragment_GameLightEffect.this.selectItem == position) {
                            Fragment_GameLightEffect.this.selectItem = -1;
                        } else {
                            Fragment_GameLightEffect.this.selectItem = position;
                        }
                        Fragment_GameLightEffect.this.adapter.notifyDataSetChanged();
                    }
                }
            });
            return convertView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(C0182R.layout.fragment_gamelighteffect, new RelativeLayout(getActivity()), true);
        initui(v);
        return v;
    }

    private void initui(View v) {
        this.gameLightEffect_listView = (ListView) v.findViewById(C0182R.id.gameLightEffect_listView);
        ...
        this.gameLightEffect_listView.setAdapter(this.adapter);
