...
public class EqualradiusRingView extends ImageView {
    ...
    public EqualradiusRingView(Context context) {
        super(context);
    ...
    public EqualradiusRingView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public EqualradiusRingView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        this.mFillRadius = (float) ((getWidth() / 2) - this.mColorWheelThickness);
