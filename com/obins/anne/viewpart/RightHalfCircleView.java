...
public class RightHalfCircleView extends ImageView {
    ...
    public RightHalfCircleView(Context context) {
        super(context);
    ...
    public RightHalfCircleView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RightHalfCircleView(Context context, AttributeSet attrs, int defStyle) {
